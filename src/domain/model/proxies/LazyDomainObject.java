...
public class LazyDomainObject<Proxy extends DomainModelObject> extends DomainModelObject {
     ...
     * @param cls - specific class object of the proxied type, we need this to identify the lazy loading in the datamapper
     * @param key - key identifying the relational identity of the lazy object
     */
    ...
    /**
     * Get the proper object that is loaded by this proxy.
     * Makes sure value is loaded before trying to grab it
     */
