...
public class TestActivityList {
	...
	activity = new Activity(1,"Running", new Date(12345), 40, 100, new Person(0, "Theordore"));
	...
	assertEquals(activityList.getActivities().size(), 0);
	activityList.insert(activity);
	Activity newActivity = new Activity(1, "Walking", new Date(12345), 40, 100, new Person(0, "Theordore"));
	activityList.update(newActivity, 0);
	assertEquals(activityList.getActivities().get(0).getType(), newActivity.getType());
    }
