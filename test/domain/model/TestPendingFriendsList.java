...
public class TestPendingFriendsList {
    ...
    public void testInitialization() {
        assertNotNull(person.getPendingFriends().getIncomingAsArrayList());
    }

    @Test
    public void testInsertingFriend() {
        person.getPendingFriends().insert(friend);
        assertEquals(person.getPendingFriends().getIncomingAsArrayList().size(), 1);
    }
    ...
    public void testAcceptingRequest() {
        ...
        assertEquals(person.getPendingFriends().getIncomingAsArrayList().size(), 0);
